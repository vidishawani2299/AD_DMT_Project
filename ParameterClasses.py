...
class Parameters:
    def __init__(self, therapy):
        ...
        # calculate transition probabilities between AD states
        if self.therapy == Therapies.SOC:
            # calculate transition probability matrix for the donepezil
        ...
        self.stateUtilities = data.STATE_UTILITY
